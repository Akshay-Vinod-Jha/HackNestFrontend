...
export default function ContributionCard({ score = 0 }) {
  ...
  // Convert 1-5 scale to percentage for width
  ...
  return (
    <div className="bg-white rounded-3xl border border-gray-100 p-6 shadow-sm hover:shadow-md transition-all h-full flex flex-col justify-between">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h2 className="text-sm font-black text-gray-900 uppercase tracking-wider">Contribution</h2>
      </div>
      ...
      <p className="text-gray-500 font-medium text-sm">
        Measures overall impact, code quality, and team collaboration.
      </p>
    </div>
  );
}

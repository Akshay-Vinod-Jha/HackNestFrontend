  ...
  return (
    <div className="bg-white rounded-3xl border border-gray-100 shadow-sm hover:shadow-md transition-all h-full flex flex-col p-6 relative overflow-hidden group">
      ...
      <div className="mb-4 flex-1">
        <h3 className="text-xl font-extrabold text-gray-900 truncate mb-1 group-hover:text-purple-600 transition-colors" title={hackathon.title}>
      ...
      <div className="mt-auto pt-4 border-t border-gray-50 flex gap-2">
        <Link 
          ...
          className="flex-1 py-3 bg-gray-50 hover:bg-purple-50 text-purple-600 hover:text-purple-700 text-center font-bold text-sm rounded-xl transition-colors active:scale-95"
        >
          View Hackathon
        </Link>
      </div>

    ...
    <div className="bg-white rounded-[2rem] border border-gray-100 shadow-sm hover:shadow-md transition-all duration-300 p-6 group flex flex-col h-full">
      ...
      <div className="mt-4 pt-4 border-t border-gray-50 flex gap-3">
        <Link 
          ...
          className="flex-1 inline-flex items-center justify-center px-4 py-2.5 bg-blue-50 hover:bg-blue-100 text-blue-700 font-bold rounded-xl transition-colors active:scale-[0.98] gap-2 text-sm"
        >
          View Team
        </Link>
        {invitation.status === 'PENDING' && (
          <>
            <button 
              ...
              className="flex-1 inline-flex items-center justify-center px-4 py-2.5 bg-emerald-500 hover:bg-emerald-600 text-white font-bold rounded-xl transition-colors active:scale-[0.98] gap-2 text-sm disabled:opacity-70 disabled:cursor-not-allowed"
            >
            ...
            <button 
              ...
              disabled={isSubmitting}
              className="flex-none inline-flex items-center justify-center px-4 py-2.5 bg-white border border-rose-200 text-rose-600 hover:bg-rose-50 font-bold rounded-xl transition-colors active:scale-[0.98] gap-2 text-sm disabled:opacity-70 disabled:cursor-not-allowed"
              title="Decline"
            >

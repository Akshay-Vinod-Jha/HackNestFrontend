  ...
  return (
    <div className="bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 rounded-[2rem] p-8 sm:p-10 lg:p-12 text-white shadow-xl shadow-blue-900/20 relative overflow-hidden">
      <div className="relative z-10 max-w-2xl">
        ...
        <Link 
          to="/hackathons"
          className="inline-flex bg-white text-blue-700 px-8 py-4 rounded-2xl font-black hover:bg-blue-50 transition-all shadow-sm items-center gap-3 group active:scale-[0.98]"
        >
          Explore Hackathons

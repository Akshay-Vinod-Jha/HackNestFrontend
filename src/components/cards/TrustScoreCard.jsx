  ...
  return (
    <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 md:p-8 flex flex-col justify-between h-full">
      <div>
        ...
        <p className="text-sm font-medium mb-6 text-gray-500">Based on team feedback, completed events, and verified skills.</p>
      </div>

      <div className="flex flex-col flex-1 justify-end">
        <div className="flex items-end gap-2 mb-3">
          <span className="text-6xl font-black tracking-tighter leading-none text-green-500">{score}</span>
          <span className="font-bold mb-1 text-lg text-gray-400">/ 100</span>
        </div>
